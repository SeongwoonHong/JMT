...
import { Search, SVGContainer, ModalContainer } from 'components';
...
const StyledSubHeaderTopText = styled.div`
  font-weight: bold;
  font-size: 23px;
  display: flex;
...
const StyledSubHeaderMiddleText = styled.div`
  margin-top: 10px;
  border: none;
`;

const StyledSubHeaderBottomText = styled.div`
  display: flex;
  justify-content: space-between;
  margin-top: 10px;
  margin-bottom: 5px;
